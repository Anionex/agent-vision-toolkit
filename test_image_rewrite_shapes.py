#!/usr/bin/env python3
"""Unit test: image rewrite must cover both request shapes.
...
def main():
    ...
    ra = mod._rewrite_image_inputs(body_a, glance_cmd)
    rb = mod._rewrite_image_inputs(body_b, glance_cmd)
    rc = mod._rewrite_image_inputs(body_c, glance_cmd)
